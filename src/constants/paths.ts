...
export const paths: Paths = {
  ...
  matro: [
    {
      name: "Cards",
      component: lazy(() => import("@participants/matro/6-cards-challenge")),
    },
  ],
  monika: [
    {
  ...
  michal: [
    {
      name: "Wallet",
      component: lazy(() => import("@participants/michal/06_wallet")),
    },
    {
      name: "Jumping ball",
    ...
    {
      name: "Swipe list items",
      component: lazy(() => import("@participants/michal/14_swipe_list_items")),
    },
  ],
};
